...
% XeLaTeX/LuaLaTeX: fontspec para fuentes modernas
\usepackage{fontspec}
...
% Aseguramos que la familia por defecto sea sans para la plantilla
...
\begin{center}
  \colorbox{headerbg}{%
    \parbox{0.95\linewidth}{%
      \vspace{1em}
      \centering
      % Nombre en DejaVu Sans Bold
      {\dejavusans\Huge\color{headerfg}\textbf{Nicolás Friz Pereira}}\\[4pt]
      {\dejavusans\large\color{headerfg}\textbf{Ingeniero Informático}}\\[1pt]
...
\begin{center}
  \begin{tabular}{c@{\hspace{1.5cm}}c@{\hspace{1.5cm}}c@{\hspace{1.5cm}}c}
    ...
    \icon{Globe}{12}{\href{https://nifrizp.dev}{Portafolio - nifrizp.dev}} &
...
\cvsect{Experiencia}
\begin{itemize}
  \item \textbf{febrero 2025 -- diciembre 2025 | Desarrollador web y Asesoría en TI – TEQMED SpA, Concepción.}
...
\begin{itemize}
  ...
  \item \textbf{2008 -- 2019 | Enseñanza Básica y Media Humanista Científica.}
...
\begin{itemize}
  ...
  \item \textbf{2024:} IBM Agile Explorer, Quantum Conversations y WatsonX Essentials.
